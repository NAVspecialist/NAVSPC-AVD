/// <summary>
/// Report Standard Sales - Invoice-AVD (ID 50100).
/// </summary>
report 50100 "Standard Sales - Invoice-AVD"
{
    RDLCLayout = './Reports/StandardSxxxalesInvoice.rdlc';
    WordLayout = './Reports/StandardSalesInvoice-AVD.docx';
    Caption = 'Sales - Invoice AVD';
    DefaultLayout = Word;
    ...
    begin
        IsHandled := false;
        //#  OnBeforeUpdateTrackingSpecBuffer  (false, LocalTrackingSpecBuffer, TempTrackingSpecBuffer, IsHandled);
        if IsHandled then
            exit;
